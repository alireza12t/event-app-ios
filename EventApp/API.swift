  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct UpdateProfile: GraphQLSelectionSet {
      ...
      public init(errors: [Error?]? = nil, user: User? = nil) {
        self.init(unsafeResultMap: ["__typename": "ProfileMutationPayload", "errors": errors.flatMap { (value: [Error?]) -> [ResultMap?] in value.map { (value: Error?) -> ResultMap? in value.flatMap { (value: Error) -> ResultMap in value.resultMap } } }, "user": user.flatMap { (value: User) -> ResultMap in value.resultMap }])
      }
      ...
      public struct Error: GraphQLSelectionSet {
        ...
        public init(messages: [String]) {
          self.init(unsafeResultMap: ["__typename": "ErrorType", "messages": messages])
        }
...
public final class NewMatchMutation: GraphQLMutation {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
    mutation NewMatch {
  ...
  public let operationName: String = "NewMatch"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("matchmakingRequest", type: .object(MatchmakingRequest.selections)),
      ]
    }
    ...
    public init(matchmakingRequest: MatchmakingRequest? = nil) {
      self.init(unsafeResultMap: ["__typename": "Mutation", "matchmakingRequest": matchmakingRequest.flatMap { (value: MatchmakingRequest) -> ResultMap in value.resultMap }])
    }

    public var matchmakingRequest: MatchmakingRequest? {
      get {
        return (resultMap["matchmakingRequest"] as? ResultMap).flatMap { MatchmakingRequest(unsafeResultMap: $0) }
      }
      set {
        resultMap.updateValue(newValue?.resultMap, forKey: "matchmakingRequest")
      }
    }

    public struct MatchmakingRequest: GraphQLSelectionSet {
      public static let possibleTypes: [String] = ["MatchmakingRequestMutation"]
      ...
      public static var selections: [GraphQLSelection] {
        return [
          ...
          GraphQLField("success", type: .scalar(Bool.self)),
          GraphQLField("errors", type: .scalar(String.self)),
          GraphQLField("request", type: .object(Request.selections)),
        ]
      }
      ...
      public init(success: Bool? = nil, errors: String? = nil, request: Request? = nil) {
        self.init(unsafeResultMap: ["__typename": "MatchmakingRequestMutation", "success": success, "errors": errors, "request": request.flatMap { (value: Request) -> ResultMap in value.resultMap }])
      }
      ...
      public var request: Request? {
        get {
          return (resultMap["request"] as? ResultMap).flatMap { Request(unsafeResultMap: $0) }
        }
        set {
      ...
      public struct Request: GraphQLSelectionSet {
        public static let possibleTypes: [String] = ["MatchmakingRequestType"]
        ...
        public init(id: GraphQLID) {
          self.init(unsafeResultMap: ["__typename": "MatchmakingRequestType", "id": id])
        }
...
public final class CheckMatchingQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
    query CheckMatching {
  ...
  public let operationName: String = "CheckMatching"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public init(matchmakingRequest: MatchmakingRequest? = nil) {
      self.init(unsafeResultMap: ["__typename": "Query", "matchmakingRequest": matchmakingRequest.flatMap { (value: MatchmakingRequest) -> ResultMap in value.resultMap }])
    }
    ...
    public struct MatchmakingRequest: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
          GraphQLField("id", type: .nonNull(.scalar(GraphQLID.self))),
          GraphQLField("match", type: .object(Match.selections)),
        ]
      }
      ...
      public init(id: GraphQLID, match: Match? = nil) {
        self.init(unsafeResultMap: ["__typename": "MatchmakingRequestType", "id": id, "match": match.flatMap { (value: Match) -> ResultMap in value.resultMap }])
      }
      ...
      public struct Match: GraphQLSelectionSet {
        ...
        public static var selections: [GraphQLSelection] {
          return [
            ...
            GraphQLField("parties", type: .nonNull(.list(.nonNull(.object(Party.selections))))),
          ]
        }
        ...
        public init(conversationId: String? = nil, parties: [Party]) {
          self.init(unsafeResultMap: ["__typename": "MatchType", "conversationId": conversationId, "parties": parties.map { (value: Party) -> ResultMap in value.resultMap }])
        }
        ...
        public var parties: [Party] {
          get {
            return (resultMap["parties"] as! [ResultMap]).map { (value: ResultMap) -> Party in Party(unsafeResultMap: value) }
          }
          set {
            resultMap.updateValue(newValue.map { (value: Party) -> ResultMap in value.resultMap }, forKey: "parties")
          }
        }

        public struct Party: GraphQLSelectionSet {
          public static let possibleTypes: [String] = ["UserNode"]
